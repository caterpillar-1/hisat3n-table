...
impl TaskIter {
    ...
    fn advance_dna_location_to_align_location() -> () {
    }
}
...
impl Iterator for TaskIter {
    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        let mut dna_locations: Option<isize> = None; // dna seq location
        ...
        loop {
            if self.peeked_align_line.is_some() {
                let peeked_align_line = &mut self.peeked_align_line.unwrap();
